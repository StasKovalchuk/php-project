...
<link rel="stylesheet" type="text/css" href="style/jquery.ui.timepicker.css" />
<link rel="stylesheet" type="text/css" href="style/start/jquery-ui-1.8.21.custom.css" />
<!--[if IE 7]><link rel="stylesheet" type="text/css" href="css/ie7.css" /><![endif]-->
<script type="text/javascript" src="js/jquery.js"></script>
<script type="text/javascript" src="js/admin/jquery-ui-1.8.2.custom.min.js"></script>
<script type="text/javascript" src="js/admin/jquery-ui-1.8.21.custom.min.js"></script>
<script type="text/javascript" src="js/admin/jquery.ui.timepicker.js"></script>
...
<div id="header"><!-- Start of Header --> 
    ...
    <ul>  <!--  Start of Tab Controls -->
		<li><a href="#"> <?=lang('hello');?>, <?=$_SESSION['username'];?> :</a></li> 
		<li><a href="admin.php?view=exit_cab"><?=lang('exit');?></a></li> 
...
<div class="container"><!--  Start of container -->
	...
	<div class="left-col"><!--  Start of Left Column -->
      ...
      <h4 class="ae-widget-header"><?=lang('menu');?></h4><!--  Widget  header -->
      <div class="ae-widget-content"><!--  Start of Widget Content -->
      
      <ul class="topnav">
    <li><a href="#"><?=lang('news');?></a>
     <ul>
      <li><a href="admin.php?view=news"><?=lang('all');?> <?=lang('news');?></a></li>
      <li><a href="admin.php?view=news&t=add"><?=lang('add');?></a></li>
     </ul>
    </li>
    <li><a href="#"><?=lang('video');?></a>
     <ul>
      <li><a href="admin.php?view=video"><?=lang('all');?> <?=lang('video');?></a></li>
      <li><a href="admin.php?view=video&t=add"><?=lang('add');?></a></li>
     </ul>
    </li>
    <li><a href="#"><?=lang('gallery');?></a>
     <ul>
      <li><a href="admin.php?view=photos"><?=lang('all');?> <?=lang('photo');?></a></li>
      <li><a href="admin.php?view=photos&t=add"><?=lang('add');?></a></li>
     </ul>
    </li>
    <li><a href="#"><?=lang('comments');?></a>
     <ul>
      <li><a href="admin.php?view=comments"><?=lang('all');?> <?=lang('comments');?></a></li>
     </ul>
    </li>
   </ul>
